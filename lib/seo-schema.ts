// Zod schema for SEO report validation - focused on content analysis from scraping
// data. Removed SERP and on-page sections that require different data sources
    ...
    competitors: z
        ...
        summary: z
            .object({
                ...
                long_term_opportunites: z.array(z.string()).optional(),
            })
            .optional(), // Make optional to handle incomplete AI responses
});
