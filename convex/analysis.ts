...
export const runAnalysis = internalAction({
    ...
    handler: async (ctx, args) => {
        ...
        try {
            ...
            // It auto uses process.env.OPENAI_API_KEY
            ...
            // It it's a schema validation error, provide more specific feedback
 ...
 * This is used for smart retires when analysis fails but scraping succeeded.
 */
