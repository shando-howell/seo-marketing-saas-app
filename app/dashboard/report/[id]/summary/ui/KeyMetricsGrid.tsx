...
export function KeyMetricsGrid({ seoReport }: KeyMetricsGridProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            {/* Total Sources */}
            <Card className="relative overflow-hidden border bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 group hover:shadow-md transition-all duration-300">
            ...
            <Card className="relative overflow-hidden border bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 group hover:shadow-md transition-all duration-300">
                <div className="absolute top-0 right-0 w-20 h-20 bg-orange-400/10 rounded-full -translate-y-10 transalte-x-10 group-hover:scale-150 transition-transform duration-500" />
                <CardContent className="p-6 relative">
                    <div className="flex items-center justify-between mb-4">
                        <div>
            ...
            {/* Competitors */}
            <Card className="relative overflow-hidden border-bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/50 group hover:shadow-md transition-all duration-300">
                <div className="absolute top-0 right-0 w-20 h-20 bg-purple-400/10 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150">
