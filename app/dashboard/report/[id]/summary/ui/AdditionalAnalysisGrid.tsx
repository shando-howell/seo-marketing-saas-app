...
function AdditionalAnalysisGrid({seoReport}: AdditionalAnalysisGridProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="border bg-gradient-to-br from-card to-card/95">
                <CardHeader className="pb-6">
                    <div className="flex items-center gap-3">
                        <div className="p-3 rounded-ful bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/50 dark:to-purple-900/50">
                ...
                <CardContent>
                    <div className="grid gap-6 max-h-96 overflow-y-auto">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between mb-3">
                                                    ...
                                                    <Badge className={`${config.badgeClass} border-0 text-sm px-3 py-1 capitalize ml-2`}>
                        ...
                        {(!seoReport?.backlink_analysis?.backlink_sources || seoReport.backlink_analysis.backlink_sources.length === 0) && (
            ...
            {/* Content Themes and Domain Analysis */}
            <Card className="border bg-gradient-to-br from-card to-card/95">
                <CardHeader className="pb-6">
                    <div className="flex items-center gap-3">
