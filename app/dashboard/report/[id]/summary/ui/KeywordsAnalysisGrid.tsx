              ...
              (keyword, index) => {
                const intentConfig = {
                  informational: {
                    ...
                    badgeClass: "bg-blue-100 text-blue-700 darl:bg-blue-900/50 dark:text-blue-300",
                    icon: Search,
                  },
                  navigational: {
                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3 mb-3">
                          ...
                          <Badge className={`${config.badgeClass} border-0 text-xs sm:text-sm px-2 sm:px-3 py-1 capitalize self-start`}>
                            ...
                            {keyword.evidence.map((evidence, evidenceIndex) => (
                              ...
                              >
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                  ...
                                  <Badge
                                    variant="outline"
                                    className="text-xs bg-white/60 dark:bg-black/20 self-start sm:self-center flex-shrink-0"
                                  >
