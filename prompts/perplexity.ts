...
export function buildPerplexityPrompt(target: string): string {
    return `
        ...
        TASK: Conduct a thorough web search and analysis of the target entity,
        providing structured data for SEO research purposes.
        ...
        2. **SOURCE CATEGORIZATION**: For each relevant result, categorize and extract:
            ...
            - **Educational**: Course platforms, tuorial sites, educational content
        ...
        4. **BACKLINK ANALYSIS**: Specifically research and identify:
            ...
            - **Citation Sources**: News articles, blog posts, directory listing that reference them
            ...
            - **Directory Lisitngs**: Professional directories, industry listings, awards
            - **Backlink Quality**: Assess domain authority, relevance, and link context
            - **Link Types**: Do-follow vs no-follow, contextual-directory, editorial vs user-generation

        5. **COMPREHENSIVE NARRATIVE**: Provide a detailed **answer_text** that includes:
            - Entity overview and primary activites
            ...
            - Current affiliation and partnerships
        ...
        7. **EVIDENCE-BASED**: Include specific facts, numbers, and claims with source attribution. Be
        as comprehensive and factual as possible.
